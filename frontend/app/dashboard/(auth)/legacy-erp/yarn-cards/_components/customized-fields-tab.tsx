...
// Reuses the existing generic custom-fields engine (CustomField / CustomFieldValue,
// entities.controller.ts / entities.service.ts) — the same infrastructure Style Cards
// already uses, just scoped to entity = "YarnCard" instead of "StyleCard". No new backend
// module, no new table.
const ENTITY = "YarnCard";
