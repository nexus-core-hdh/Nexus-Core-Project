...
// Reuses the existing generic custom-fields engine — same infrastructure Inventory Receipt/Yarn
// Card/Style Card already use, just scoped to entity = "FiReceipt". No new backend module.
const ENTITY = "FiReceipt";
